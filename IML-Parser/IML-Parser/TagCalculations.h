...
double agg_sum(std::vector<double>& content)
{
	double sum = 0;
	int size = content.size();
	for (size_t i = 0; i < size; i++)
...
double agg_pro(std::vector<double>& content)
{
	double product = 1;
	int size = content.size();
	for (size_t i = 0; i < size; i++)
...
double agg_avg(std::vector<double>& content)
{
	double sum = 0;
	int size = content.size();
	for (size_t i = 0; i < size; i++)
...
double agg_fst(std::vector<double>& content)
{
	return content[0];
}

double agg_lst(std::vector<double>& content)
{
